...
class Disk(object):
    ...
    def __init__(self, win32_diskdrive, win32_logicaldisks):
        self.win32_logicaldisks = win32_logicaldisks
        self.win32_diskdrive = win32_diskdrive
        self._letter = ""
    ...
    @property
    def disk_index(self):
        return self.win32_diskdrive.Index
    ...
    @property
    def serial(self):
        return format_serial_number(self.win32_diskdrive.SerialNumber.strip())

    @property
    def size(self):
        return self.win32_diskdrive.Size

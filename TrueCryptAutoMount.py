...
class TrueCrypt_AutoMounter(QtGui.QMainWindow):
	...
	def button_postmountbatch_click_event(self):
		tree_item = self.ui.treeVolumeList.currentItem()
		drive_letter = tree_item.text(0)
		title = '%s Post-Mount Batch' % tree_item.text(0)
		label = 'The following commands will be executed after drive %s has been mounted. Use && to concatinate commands.' % tree_item.text(0)
		old_commands = []
